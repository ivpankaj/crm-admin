...
const EmployeeProfile = () => {
  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      try {
        const response = await fetch(`${api_url}/employee/get/${employeeId}`, {
          method: 'GET',
          headers: {
  ...
  return (
    <>
      ...
      <div className="min-h-screen p-8 bg-gray-900">
        <button
          onClick={() => navigate(-1)}
          className="mb-4 px-4 py-2 text-sm font-medium text-white bg-gray-700 rounded hover:bg-gray-600 transition duration-300"
        >
          Back
        </button>
