...
const Taskall_sales_person: React.FC = () => {
    ...
    return (
        <div className="p-4 bg-gray-100 min-h-screen">
            <h1 className="text-3xl font-bold mb-6">Sales person Tasks</h1>
            <button 
                    ...
                    {tasks.map((task) => (
                        <div key={task.id} className="dark:border dark:border-white border border-black p-6 rounded-lg shadow-lg">
                            ...
                            <p className="text-gray-500 mb-2">
                                Priority: <span className="font-medium">{task.priority}</span> {/* Assuming status is priority */}
                            </p>
                            <p className="text-gray-500 mb-2">
                                sales_personId: <span className="font-medium">{task.sales_personId}</span>
                            </p>
...
export default Taskall_sales_person;
